...
- [Open a private security advisory](https://github.com/mulgadc/spinifex/security/advisories/new) on this repository.
...
Spinifex is one part of the [Mulga](https://mulgadc.com) stack. If a vulnerability spans more than one component, report it once against whichever repository you found it in and we will handle the rest.
