...
The [AWS model operation coverage](aws-model-operation-coverage.md) report is
generated from Spinifex's dispatch tables and the pinned AWS API models. Run
`make aws-model-coverage` to regenerate and print it.
