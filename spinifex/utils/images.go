...
var AvailableImages = map[string]Images{
	...
	"debian-13-x86_64": {
		...
		URL:          "https://cloud.debian.org/images/cloud/trixie/20260722-2547/debian-13-genericcloud-amd64-20260722-2547.tar.xz",
		Checksum:     "https://cloud.debian.org/images/cloud/trixie/20260722-2547/SHA512SUMS",
		ChecksumType: "sha512",
		BootMode:     "uefi",
	},
	...
	"debian-13-arm64": {
		...
		Platform:     "Linux/UNIX",
		CreatedAt:    time.Date(2026, 7, 22, 0, 0, 0, 0, time.UTC),
		URL:          "https://cloud.debian.org/images/cloud/trixie/20260722-2547/debian-13-genericcloud-arm64-20260722-2547.tar.xz",
		Checksum:     "https://cloud.debian.org/images/cloud/trixie/20260722-2547/SHA512SUMS",
		ChecksumType: "sha512",
		BootMode:     "uefi",
	},
	...
	"ubuntu-26.04-x86_64": {
		...
		URL:          "https://cloud-images.ubuntu.com/releases/resolute/release-20260720/ubuntu-26.04-server-cloudimg-amd64.img",
		Checksum:     "https://cloud-images.ubuntu.com/releases/resolute/release-20260720/SHA256SUMS",
		ChecksumType: "sha256",
		BootMode:     "uefi",
	},
	...
	"ubuntu-26.04-arm64": {
		...
		Platform:     "Linux/UNIX",
		CreatedAt:    time.Date(2026, 7, 20, 0, 0, 0, 0, time.UTC),
		URL:          "https://cloud-images.ubuntu.com/releases/resolute/release-20260720/ubuntu-26.04-server-cloudimg-arm64.img",
		Checksum:     "https://cloud-images.ubuntu.com/releases/resolute/release-20260720/SHA256SUMS",
		ChecksumType: "sha256",
		BootMode:     "uefi",
	},

	"alpine-3.22.5-x86_64": {
		Name:         "alpine-3.22.5-x86_64",
		Description:  "Alpine Linux 3.22.5 x86_64 cloud image",
		Distro:       "alpine",
		Version:      "3.22.5",
		Arch:         "x86_64",
		Platform:     "Linux/UNIX",
		CreatedAt:    time.Date(2026, 6, 21, 0, 0, 0, 0, time.UTC),
		URL:          "https://dl-cdn.alpinelinux.org/alpine/v3.22/releases/cloud/generic_alpine-3.22.5-x86_64-uefi-cloudinit-r0.qcow2",
		Checksum:     "https://dl-cdn.alpinelinux.org/alpine/v3.22/releases/cloud/generic_alpine-3.22.5-x86_64-uefi-cloudinit-r0.qcow2.sha512",
		ChecksumType: "sha512",
		BootMode:     "uefi",
	},

	"alpine-3.22.5-arm64": {
		Name:         "alpine-3.22.5-arm64",
		Description:  "Alpine Linux 3.22.5 arm64 cloud image",
		Distro:       "alpine",
		Version:      "3.22.5",
		Arch:         "arm64",
		Platform:     "Linux/UNIX",
		CreatedAt:    time.Date(2026, 6, 21, 0, 0, 0, 0, time.UTC),
		URL:          "https://dl-cdn.alpinelinux.org/alpine/v3.22/releases/cloud/generic_alpine-3.22.5-aarch64-uefi-cloudinit-r0.qcow2",
		Checksum:     "https://dl-cdn.alpinelinux.org/alpine/v3.22/releases/cloud/generic_alpine-3.22.5-aarch64-uefi-cloudinit-r0.qcow2.sha512",
		ChecksumType: "sha512",
		BootMode:     "uefi",
	},
