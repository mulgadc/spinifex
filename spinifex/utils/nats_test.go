...
func TestNATSRequest_Success(t *testing.T) {
	...
	result, err := NATSRequestCtx[Resp](context.Background(), nc, "test.greet", Req{Name: "world"}, 2*time.Second, "")
	require.NoError(t, err)
...
func TestNATSRequest_ErrorResponse(t *testing.T) {
	...
	type Resp struct{}
	_, err = NATSRequestCtx[Resp](context.Background(), nc, "test.fail", struct{}{}, 2*time.Second, "")
	assert.Error(t, err)
...
func TestNATSRequest_NoResponders(t *testing.T) {
	...
	type Resp struct{}
	_, err = NATSRequestCtx[Resp](context.Background(), nc, "test.nobody", struct{}{}, 500*time.Millisecond, "")
	assert.Error(t, err)
}
...
func TestNATSRequest_Timeout(t *testing.T) {
	...
	type Resp struct{}
	_, err = NATSRequestCtx[Resp](context.Background(), nc, "test.slow", struct{}{}, 100*time.Millisecond, "")
	assert.Error(t, err)
}
...
func TestNATSRequest_InvalidUnmarshal(t *testing.T) {
	...
	_, err = NATSRequestCtx[Resp](context.Background(), nc, "test.badjson", struct{}{}, 2*time.Second, "")
	assert.Error(t, err)
...
func TestNATSRequest_AccountIDHeader(t *testing.T) {
	...
	result, err := NATSRequestCtx[Resp](context.Background(), nc, "test.account", Req{Name: "world"}, 2*time.Second, "111122223333")
	require.NoError(t, err)
	assert.Equal(t, "hello world", result.Greeting)
...
func TestNATSRequest_MarshalError(t *testing.T) {
	...
	_, err = NATSRequestCtx[Resp](context.Background(), nc, "test.marshalfail", make(chan int), 2*time.Second, "")
	assert.Error(t, err)
...
func TestNATSRequest_DisconnectedFastFail(t *testing.T) {
	...
	start := time.Now()
	_, err = NATSRequestCtx[map[string]any](context.Background(), nc, "ec2.Describe", struct{}{}, 5*time.Second, "")
	elapsed := time.Since(start)
...
func TestNATSRequest_NilConn_ReturnsClusterUnavailable(t *testing.T) {
	type Resp struct{}
	_, err := NATSRequestCtx[Resp](context.Background(), nil, "test.never", struct{}{}, 50*time.Millisecond, "")
	require.Error(t, err)
...
func TestNATSRequest_ClosedConn_ReturnsClusterUnavailable(t *testing.T) {
	...
	type Resp struct{}
	_, err = NATSRequestCtx[Resp](context.Background(), nc, "test.never", struct{}{}, 50*time.Millisecond, "")
	require.Error(t, err)
	assert.ErrorIs(t, err, ErrClusterUnavailable)
}
...
func TestGather_EarlyExitBeforeTimeout(t *testing.T) {
	...
	start := time.Now()
	frames, sum, err := GatherCtx(context.Background(), nc, "test.gather.early", []byte("{}"),
...
func TestGather_TimesOutBelowExpected(t *testing.T) {
	...
	frames, sum, err := GatherCtx(context.Background(), nc, "test.gather.timeout", []byte("{}"),
...
func TestGather_MixedSuccessAndErrors(t *testing.T) {
	...
	frames, sum, err := GatherCtx(context.Background(), nc, "test.gather.mixed", []byte("{}"),
...
func TestGather_StopOnFirstSkipsErrors(t *testing.T) {
	...
	frames, sum, err := GatherCtx(context.Background(), nc, "test.gather.first", []byte("{}"),
...
func TestGather_OversizedFrameDropped(t *testing.T) {
	...
	frames, sum, err := GatherCtx(context.Background(), nc, "test.gather.oversized", []byte("{}"),
...
func TestGather_AccountIDHeaderSet(t *testing.T) {
	...
	frames, _, err := GatherCtx(context.Background(), nc, "test.gather.acct.set", []byte("{}"),
...
func TestGather_AccountIDHeaderAbsentWhenEmpty(t *testing.T) {
	...
	frames, _, err := GatherCtx(context.Background(), nc, "test.gather.acct.empty", []byte("{}"),
...
func TestGather_NilConn_ReturnsClusterUnavailable(t *testing.T) {
	frames, sum, err := GatherCtx(context.Background(), nil, "test.never", []byte("{}"),
...
func TestGather_ClosedConn_ReturnsClusterUnavailable(t *testing.T) {
	...
	_, _, err = GatherCtx(context.Background(), nc, "test.never", []byte("{}"),
		GatherOpts{Timeout: 50 * time.Millisecond, ExpectedNodes: 1})
	require.ErrorIs(t, err, ErrClusterUnavailable)
}
